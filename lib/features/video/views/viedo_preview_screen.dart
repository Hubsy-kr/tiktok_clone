...
class VideoPreviewScreen extends ConsumerStatefulWidget {
  ...
  @override
  createState() => VideoPreviewScreenState();
}
...
class VideoPreviewScreenState extends ConsumerState<VideoPreviewScreen> {
  ...
  void _onUploadPressed() {
    ref
        .read(uploadVideoViewModel.notifier)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: ref.watch(uploadVideoViewModel).isLoading
                ? () {}
                : _onUploadPressed,
            icon: ref.watch(uploadVideoViewModel).isLoading
